...
import { SearchUniversitiesComponent } from "src/app/pages/search-universities/search-universities.component";
...
const routes: Routes = [
  {
    ...
    children: [
      { path: "search-program", component: SearchUniversitiesComponent },
